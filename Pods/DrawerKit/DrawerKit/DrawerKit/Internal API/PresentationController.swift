...
final class PresentationController: UIPresentationController {
    ...
    var containerViewPanGR: UIPanGestureRecognizer?
...
extension PresentationController {
    ...
    override func presentationTransitionDidEnd(_ completed: Bool) {
        ...
        enableContainerPanRecogniser(enabled: true)
    }
    ...
    override func dismissalTransitionWillBegin() {
        ...
        enableDrawerFullExpansionTapRecogniser(enabled: false)
        enableDrawerDismissalTapRecogniser(enabled: false)
        enableContainerPanRecogniser(enabled: false)
    }
